...
var punktid1;
  ...
  if (background) {
    background.classList.remove('kerged-bg', 'keskmised-bg', 'rasked-bg'); // Eemaldame olemasolevad klassid
      background.classList.add('algus-bg'); // Muudame taustavärvi roheliseks
    }
   else {
...
display.addEventListener("blur", function() {
    ...
    // Kontrollige, kas sisend on kehtiv
...
display.addEventListener("input", function() {
  ...
  document.getElementById("otsiBtn").onclick = otsi; // Lisatud nupp lingi otsimiseks
